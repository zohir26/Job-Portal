...
const AllJobs = () => {
    ...
    // the req will gone as query so useState initial value is "";
    const [maxSalary, setMaxSalary]= useState("")
    const { jobs, loading } = useJobs(sortBySalary, search, minSalary, maxSalary);
    if (loading) {
    ...
    return (
        <>
            ...
            <div className='container flex justify-center items-center gap-3'>
                ...
                <input
                    type="text" name=""
                    className=" border border-lime-300 p-4 w-full max-w-2xl rounded-lg" placeholder='Search job max salary'
                ...
                <input
                    type="text" name=""
                    className=" border border-lime-300 p-4 w-full max-w-2xl rounded-lg" placeholder='Search job by min salary'
                    // hold the search data
